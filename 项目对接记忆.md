...
**最新里程碑**:`(待推)` — BUG-018 DeepSeek 选择器失效 → 加 DOM 诊断 + 现场拾取 + 手动覆盖三件套
**前几个里程碑**:
- `c46ce4e` — 章节元信息自动注入下一章生成 + 面板说明强化
- `edb98c2` — 改名"盘古超级写作助手 v1.0.0"
...
*最后更新:2026-05-16 第十八批 / BUG-018 DOM 诊断 + 现场拾取 + 手动覆盖*
