...
**最新里程碑**:`(待推)` — BUG-016 字体倍数没生效(STYLESHEET 写死压死 app.setFont)+ AI 联动条件 typo 修复
**前几个里程碑**:
- `0b868f0` — 批量生成参数加自动保存项目 + AI 站点联动 3 checkbox 默认值(条件错了,本批修)
- `62a53ad` — 字体倍数滑块挪到 设置 菜单 → 🔍 界面字体大小
...
*最后更新:2026-05-16 第十一批 / BUG-016 字体倍数没生效(STYLESHEET 压死)+ AI 联动 typo*
