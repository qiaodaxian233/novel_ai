...
**最新里程碑**:`(待推)` — DeepSeek 抓取策略升级:p.ds-markdown-paragraph 段落聚合(用户报告新版 DOM)
**前几个里程碑**:
- `581fae7` — BUG-018 DOM 诊断 + 现场拾取 + 手动覆盖三件套
- `c46ce4e` — 章节元信息自动注入下一章生成
...
*最后更新:2026-05-16 第十九批 / DeepSeek 抓取策略升级 — p.ds-markdown-paragraph 段落聚合*
