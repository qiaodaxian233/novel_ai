...
**最新里程碑**:`(待推)` — BUG-014 完整闭环 / D-元信息 GUI 面板 / C-Ctrl+K 兜底 / B-6 库自动抽取 + canon 分类前缀(2026-05-16 第五批)
**前几个里程碑**:
- `1ca72d9` — BUG-014 章节正文剥离尾部元信息 + 伏笔自动入库(本批前半,本地 commit)
...
*最后更新:2026-05-16 第五批 / D 元信息 GUI 面板 + C Ctrl+K 兜底 + B 6 库自动抽取*
