...
**最新里程碑**:`(待推)` — BUG-024 改名工具崩溃:chars_edit 在 tab_memory 不在 tab_settings + getattr 容错
**前几个里程碑**:
- `5f2f6f5` — 全 UI 偏好实时持久化
- `c6e8486` — ✨ 每章自动抽取 6 库 持久化
...
*最后更新:2026-05-17 第三十八批 / BUG-024 改名工具崩溃修复*
