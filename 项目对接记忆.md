...
**最新里程碑**:`(待推)` — 字体倍数滑块挪到 设置 菜单 → 🔍 界面字体大小 弹对话框(用户说"放在设置里")
**前几个里程碑**:
- `eb2bd6e` — 删除 4K 自动检测,只留手动字体倍数(本地未推,被本批合并)
- `c8a99c2` — BUG-015 4K HiDPI 物理像素检测(已被简化方案替代)
...
*最后更新:2026-05-16 第九批 / 字体倍数滑块挪到 设置 菜单*
