...
**最新里程碑**:`(待推)` — v1.81 BUG-061 评分门校准 + 死磕精确定位(用户实测:"95 分阈值每次都死磕 10 次";根因 5 处:禁用词×2 / 长句 25 字 / 段落 3 句 / 破折号 1 个 / 省略号 1 个;再加死磕重写只传摘要不传定位)
**前几个里程碑**:
...
**最近更新**:2026-05-19 — v1.81 BUG-061 评分门校准 + 死磕精确定位(用户实测 95 分门每次死磕 10 次的修复)
...
*最后更新:2026-05-19 / v1.81 BUG-061 评分门校准 + 死磕精确定位*
