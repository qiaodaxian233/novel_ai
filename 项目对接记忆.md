...
**最新里程碑**:`(待推)` — v1.84 角色 POV 模式(配合 v1.79 信息隔离,堵"路人甲突然知道主角秘密"OOC bug;CharLib 顶部加下拉框选 全知/主角POV/角色POV;关系热点+信息边界按 POV 角色已知信息收窄;末尾追加 5 条 POV 视角写作约束)
**前几个里程碑**:
- `64563f0` — v1.83 UI 文案补扫(v1.82 漏的 7 处)
- `8698164` — v1.82 文档卫生 + UI 文案修正
- `ede0558` — v1.81 BUG-061 评分门校准 + 死磕精确定位
...
> **当前版本 `v1.84`**(每次推送后请同步更新此处)。**忘改 = 反例,跟"先推代码后推记忆"同等严重**。
> 详见"五十五、版本号铁律"那一节。
...
**最近更新**:2026-05-19 — v1.84 角色 POV 模式(信息隔离 v1.79 的注入侧延伸 + 第三人称限知 5 条规则)
...
*最后更新:2026-05-19 / v1.84 角色 POV 模式(信息隔离 v1.79 的注入侧延伸)*
