...
**最新里程碑**:`(待推)` — v1.87 跨表关联可视化("做没有的"系列后续延伸 4/4 = **系列收官**!CharLib 加第 14 个 sub-tab"🕸 关联图谱";QGraphicsView + 力导向布局算法(纯 Python 实现,无 cytoscape.js)绘制剧情节点↔角色/伏笔/承诺/信息网络图;类别复选框实时过滤;滚轮缩放 + 拖拽节点)
**前几个里程碑**:
...
> **当前版本 `v1.87`**(每次推送后请同步更新此处)。**忘改 = 反例,跟"先推代码后推记忆"同等严重**。
> 详见"五十五、版本号铁律"那一节。
...
**最近更新**:2026-05-19 — v1.87 跨表关联可视化("做没有的"系列收官;QGraphicsView 力导向布局纯 PyQt5)
...
*最后更新:2026-05-19 / v1.87 跨表关联可视化("做没有的"系列收官)*
