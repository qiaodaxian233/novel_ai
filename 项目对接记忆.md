...
**最新里程碑**:`(待推)` — BUG-015 4K HiDPI 检测漏掉物理像素 + 加手动字体倍数滑块兜底
**前几个里程碑**:
- `5d0ad9a` — 第六批 9 大用户反馈功能(4K HiDPI / 设置自动保存 / 项目 10 次备份 / 自定义题材-时代-金手指-人设 / 折叠链 / 对话记忆自动保存)
- `fa0dd40` — BUG-014 第二阶段:元信息 GUI 面板 / Ctrl+K 拦截 / 6 库自动同步(第五批)
...
*最后更新:2026-05-16 第七批 / BUG-015 4K HiDPI 物理像素检测 + 手动字体倍数滑块*
