...
**最新里程碑**:`(待推)` — v1.78 BUG-058 剧情进度管理("做没有的"第 2/4 步;3 子表:弧线%/关系值矩阵/目标列表;弧线 delta 累加封顶 100,关系值 ±100 + 新对 id=-1 路径;无 reeval 按钮)
**前几个里程碑**:
...
**最近更新**:2026-05-19 — v1.78 BUG-058 剧情进度管理("做没有的"第 2/4 步;3 子表:弧线/关系值/目标;v1.79=信息隔离 / v1.80=剧情树 待做)
...
*最后更新:2026-05-19 / v1.78 BUG-058 剧情进度管理("做没有的"第 2/4 步)*
