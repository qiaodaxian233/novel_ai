...
class CharacterLibrary(QWidget):
    ...
    def _build_ui(self):
        ...
        self.chk_auto_extract.setToolTip(
            ...
            "改成手动批量提取(旁边那个按钮)。")
        self.chk_auto_extract.setStyleSheet("QCheckBox { color:#997151; font-weight:bold; }")
        # 状态变化时持久化保存
        ...
        self.chk_auto_sync_hero.setStyleSheet("QCheckBox { color:#6d7c95; }")
    ...
    def _build_characters_tab(self):
        ...
        tip.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
    ...
    def _build_timeline_tab(self):
        ...
        self.lbl_hero_source.setStyleSheet(
            "color: #6d7c95; font-size: 11px; padding: 2px 4px;")
    ...
    def _build_items_tab(self):
        ...
        self.lbl_item_types.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
    ...
    def _build_plot_progress_tab(self):
        ...
        tip_arcs.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
        ...
        tip_rels.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
        ...
        tip_goals.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
    ...
    def _build_info_isolation_tab(self):
        ...
        tip_infos.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
        ...
        tip_kb.setStyleSheet("color:#6d7c95;font-size:11px;padding:4px;")
    ...
    def _open_node_cross_refs_dialog(self, item):
        ...
        ch_label.setStyleSheet("color:#6d6d6d;padding:4px 8px;font-size:11px;")
    ...
    def _build_relation_graph_tab(self):
        ...
        lbl_hint.setStyleSheet("color:#6d7c95;font-size:11px;")
    ...
    def _set_hero_readonly(self, readonly):
        ...
        for ed in getattr(self, "_hero_edits", []):
            ...
            if readonly:
                ed.setStyleSheet(
                    "QLineEdit { background:#f5f5f5; color:#6d6d6d; "
    ...
    def _on_hero_unlock_toggled(self, checked):
        ...
        if checked:
            ...
            self.lbl_hero_source.setText(
                ...
                "切回只读后,下次同步才会再次自动填")
            self.lbl_hero_source.setStyleSheet(
                "color: #977242; font-weight: bold; font-size: 11px; "
                "padding: 2px 4px;")
        else:
    ...
    def _sync_hero_from_timeline(self):
        ...
        if max_ch > 0:
            ...
            self.lbl_hero_source.setText(
                f"📌 数据来源:从时间线同步({len(extracted)}/5 字段命中)")
        self.lbl_hero_source.setStyleSheet(
            "color: #2a6dcd; font-size: 11px; padding: 2px 4px; font-weight:bold;")
