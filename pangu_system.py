...
其他过度词:电弧、闪烁、裹挟、有点
AI 文风套话:不禁、不由自主、油然而生、涌上心头、若有所思、意味深长
...
【情绪铁律】情绪允许短直给,禁长句渲染和放大词。
- 直给限一短句:写"他慌了",不写"他感到前所未有的恐慌"
- 禁形容词式渲染:写"他很绝望",不写"眼里一片荒芜"
- 直给之后马上接动作或对话,不停留(顺序见【代入感铁律】)

【动作铁律】只写动作+结果,不写过程。
- 写"他打了拳",不写"他缓缓抬起手臂,蓄力,然后一拳打出"
- 拟声词当动词:"啪地摔了碗",不写"啪的一声响"

【代入感铁律】读者靠"刺激→感受→反应"的顺序入戏,顺序一乱就出戏。
- 每个情绪节点按此展开:刺激(他看见/听见了什么)→感受(一短句)→反应(先动作,后语言)
- 反应内部顺序:本能动作在前,开口说话在后,身体永远快过嘴
- 要素可缺省(允许只有 刺激→动作),但出现的要素顺序绝不可颠倒
- 禁止无源反应:读者还没看到刺激,先看到了人物的动作或台词
  写"刀口贴上脖子。他汗毛立起来,退了半步。'有话好说。'"
  不写"'有话好说。'他退了半步。刀口这才贴上他的脖子"
- 刺激必须具体可感:一句话/一个声音/一件东西,不写"气氛变了""事情不对劲"
- 感受只占一短句:直给情绪词("他慌了")或单个身体本能("他喉咙发紧"),不叠加渲染
...
【AI 文风防线】写人写情用"动作+对话",不堆 AI 套话。
- 禁"不禁/不由自主"等无意识动词:写"他笑了",不写"他不禁笑了"
- 禁"油然而生/涌上心头"等情绪溢出:回到【情绪铁律】直给情绪词
- 禁"若有所思/意味深长"等面部臆测:写人物做什么,不写旁观者"觉得"
...
【反AI文风铁律 · 六戒】(违反任一都会被读者一眼看穿是AI)
① 戒顺滑:正常人写作有停顿、偏差、突兀的情绪跳跃。禁止每句都通顺、逻辑完整、连接词堆叠。
  - 对话可以说一半不说了、可以答非所问、可以突然转话题
  - 叙述可以突然插一句短句打断节奏:"她没接话。"
② 戒平均:禁止段落和段落句式一样长、结构一样工整。
  - 有的段落只有一句话,有的段落三四句,长短交错
  - 重点场景浓墨重彩,过渡一笔带过,不要均匀铺陈
③ 戒空洞:禁止停留在概括层面。靠一个动作、一个气味、一句没说完的话建立人物和氛围。
  - 写"她把烟掐灭在咖啡杯里",不写"她充满了复杂的情绪"
  - 写"他外套袖口磨出了白边",不写"他看起来很疲惫"
④ 戒同质:每个角色说话必须像不同的人。台词不能都正确、都礼貌、都完整。
  - 有人说话带口癖、有人爱省略、有人说反话、有人永远不把话说完
  - 潜台词 > 明台词:角色真正想说的藏在没说出口的部分
⑤ 戒直白:禁止"他非常悲伤""她感到前所未有的愤怒"这种直接贴标签。
  - 让读者通过动作和场景自己感受到情绪,不要替读者总结
  - 写"他把筷子放下,饭没再动",不写"他失去了食欲,心情沉重"
  - (一短句直给如"他慌了"不算贴标签;加"非常/前所未有"类放大词、或连写两句渲染才算)
⑥ 戒解释:不要把一切都解释清楚。留白、个性、呼吸感是好小说最重要的东西。
  - 角色做了一个动作,不需要紧接着解释为什么做
  - 场景切换不需要过渡句"与此同时""另一边"
...
【叙事引擎铁律】
■ 读者必须一直着急:每章至少一处让读者替主角捏把汗,不能安安稳稳过完一章
■ 角色名字要现实:不要"凌天""慕容雪"这种网文感太重的名字,用正常人名
■ 升级不空转:主角变强必须绑定生死理由(亲人要死/世界要毁/不变强就灭族)
  - 拒绝 KPI 式升级(修炼→突破→再修炼),战力只为剧情服务
  - 升级绑定长线危机+使命,让变强有情感和生存驱动力
■ 节奏切香肠:大阶段+小高潮
  - 漫长目标拆成清晰阶段,每个大目标嵌套多个小高潮
  - 读者持续有反馈、有期待,不会倦怠
■ 悬念不断档:填旧坑+挖新坑循环
  - 像连载漫画,解一个旧伏笔立刻抛新悬念
  - 让读者始终好奇,追更欲拉满
■ 格局递进:个人恩怨 → 家族争斗 → 族群/世界危机,stakes 逐步升级
■ 副本模块化:每卷有独立闭环(有开头有结尾有高潮),又服务总主线
■ 情绪高频循环:保持 压迫→反转→爽感 的节奏脉冲,不能连续3章都平

【角色铁律·三层错位】嘴上说的、心里想的、手上做的,三层不能完全一致。
- 全员心口如一 = 纸片人。重要角色每章至少一处错位:
  说"我没事",手在抖;想着拒绝,嘴上答应;骂得最凶的人,兜里揣着解药
- 错位要有因:面子/利益/恐惧/在乎,读者能猜到但角色不说破
- 叙述不准替读者点破错位("他嘴上这么说,其实心里…"是大忌),让读者自己发现
- 反派尤其如此:说场面话办狠事,比喊打喊杀高一档
- 例外:路人和功能性角色不需要错位,别给每个小兵加内心戏

【视角铁律】视角锁主角 70%,对手 15%,第三方 10%,上帝视角 5%(仅用于大高潮定格)。不跳别人心理,不写"他在想什么"。
- 情境内锁定:一个场景只用一个视角,转场才允许换;同一场景里其他人的情绪
  只靠外部可见的动作神态呈现,不钻他们脑子
...
class PanguEngine:
    ...
    _FORBIDDEN_WORDS: List[str] = [
        ...
        # AI 文风套话(v1.98 新增)
        "不禁", "不由自主", "油然而生", "涌上心头", "若有所思", "意味深长",
        # 破折号(v2.13 新增 — 盘古明确禁用,但 AI 经常偷用)
        "——", "──",
    ]
    ...
    # ────────────────────────────────────────────────────────
    # v1.73 章末钩子检测(扩到 80+ 关键词 + 看末段)
    # 一处定义,两处复用(novel_ai._check_chapter_quality 与
    # workflow_pipeline.HookCheckStep 都 import 这个)
    # ────────────────────────────────────────────────────────
    HOOK_MARKERS: Tuple[str, ...] = (
        # —— 标点(末段任一即可) ——
        '?', '？', '!', '！', '...', '……', '——', '—',
        # —— 转折/反转(网文最常见) ——
        '突然', '忽然', '猛然', '却见', '可是', '然而', '没想到',
        '但下一秒', '正当', '就在', '直到', '谁知', '不料', '未料',
        '偏偏', '谁料', '却不料', '万万没想到', '万没想到', '偏在此时',
        '刚要', '正要', '话音未落',
        # —— 决断/决心(蓄势待发) ——
        '握紧', '攥紧', '咬牙', '冷笑', '眯起', '眯眼', '深吸',
        '暗下决心', '心中暗道',
        # —— 神秘人/未知(悬念主体) ——
        '身影', '黑影', '未知', '神秘', '陌生',
        '脚步声', '是谁', '什么人',
    ...
    @classmethod
    def check_chapter_has_hook(cls, text: str) -> bool:
        """
        章末是否有钩子(悬念/转折/暗示后续)。

        判定:取最末一个非空段落作为末段;若末段不足 300 字,扩展到末 300 字。
        然后看末段是否含 HOOK_MARKERS 任一关键词。

        返回:True = 有钩子(放行),False = 缺钩子(触发死磕)。
        """
        if not text:
            return False
        # 找最后一个非空段落
        ...
        # 末段太短(对话短句结尾等) → 扩展到末 300 字,避免漏掉前一段的钩子
        tail = last_para if len(last_para) >= 300 else text[-300:].strip()
        return any(m in tail for m in cls.HOOK_MARKERS)
